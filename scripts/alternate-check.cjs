...
(async()=>{
 ...
 for(const mobile of [true,false]){
  ...
  await gesture();await page.waitForFunction(()=>window.__walkthroughDebug.partEnd===208&&window.__walkthroughDebug.playing);
  ...
  await page.waitForFunction(()=>window.__walkthroughDebug.frame===208);
  await gesture();
  ...
  await gesture(false);
  await page.waitForFunction(()=>window.__walkthroughDebug.playing&&window.__walkthroughDebug.partEnd===208);
  await page.waitForFunction(()=>!window.__walkthroughDebug.playing&&window.__walkthroughDebug.frame===208);
